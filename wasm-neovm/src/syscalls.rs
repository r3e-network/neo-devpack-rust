...
static EXTENDED_SYSCALLS: &[SyscallInfo] = &[
    ...
    SyscallInfo { name: "Neo.Crypto.SHA256", hash: 0x906e6e88 },
    SyscallInfo { name: "Neo.Crypto.RIPEMD160", hash: 0x8a85a0a4 },
    SyscallInfo { name: "Neo.Crypto.Murmur32", hash: 0x76259782 },
    SyscallInfo { name: "Neo.Crypto.Keccak256", hash: 0x5c8ecd46 },
    SyscallInfo { name: "Neo.Crypto.Hash160", hash: 0x57c6b646 },
    SyscallInfo { name: "Neo.Crypto.Hash256", hash: 0x3ced0552 },
    SyscallInfo { name: "Neo.Crypto.VerifyWithECDsa", hash: 0x40746983 },
    SyscallInfo { name: "Neo.Crypto.CheckSig", hash: 0xbb359497 },
    SyscallInfo { name: "Neo.Crypto.CheckMultisig", hash: 0xb8645d5f },
];
